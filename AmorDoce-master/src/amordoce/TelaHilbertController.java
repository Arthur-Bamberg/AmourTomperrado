...
public class TelaHilbertController implements Initializable {

    private String statementText = "Olá, vou coordenar você durante essa semana. Vou apresentar você ao cheff!";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        options.add("Não vou precisar muito da sua orientação, trabalho bem sozinha!");
        options.add("Tenho expectativas! Acho que serei muito bem orientada");
