...
public class TelaCarosellaController implements Initializable {

    private String statementText = "Olá, sou Paola Carosella!\n Trabalho principalmente no admnistrativo, mas também sou muito boa na cozinha!";
    private ArrayList<String> options = new ArrayList<>();
    private ClassCharacter character = App.game.getCharacter(1);
    ...
    public void initialize(URL url, ResourceBundle rb) {
        options.add("É um prazer enorme te conhecer. Você é completamente encantadora!");
        options.add("Muito prazer!");
        options.add("Nossa, não quer lavar o chão também perfeitinha?");
    ...
    public void next() throws IOException {
        App.setRoot("TelaSangreal");
    }

    public void GoToLog() throws IOException {
        App.game.setPreviousScreen("TelaCarosella");
        App.setRoot("TelaLog");
    }
}
